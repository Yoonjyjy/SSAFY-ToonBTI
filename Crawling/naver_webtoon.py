        ...
        while True:
            for i in range(len(Genres_for_Link)):
                ...
                for j in range(len(score_nums)):
                    ...
                    if soup.find('div', {'class': 'login_wrap'}):
                        time.sleep(0.5)
                        driver.back()
                        time.sleep(1)
                        continue
                    ...
                    print(score, genre, image, title, day, isDone, story_author, painting_author, author, description, tags_list)
